...
const RuntimeFunctionDescriptor kRuntimeFunctions[] = {
    ...
    ELX_RUNTIME_FUNCTION(elx_call_native_fast,
                         Value_Value_ValuePtr_I32_I8Ptr_I32, RuntimeNoFlags),
    ELX_RUNTIME_FUNCTION(elx_call_method_fast,
    ...
    ELX_RUNTIME_FUNCTION(elx_subtract_values, Value_Value_Value,
                         RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_multiply_values, Value_Value_Value,
                         RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_divide_values, Value_Value_Value,
                         RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_greater_values, Value_Value_Value,
                         RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_greater_equal_values, Value_Value_Value,
                         RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_less_values, Value_Value_Value, RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_less_equal_values, Value_Value_Value,
                         RuntimeNoUnwind),
    ELX_RUNTIME_FUNCTION(elx_equal_values, Value_Value_Value,
                         RuntimeNoUnwind),
